                                    ...
                                    <div class="row justify-content-between">
                                        <div class="col-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label text-secondary" for="remember_me" style="color: black;">
                                                    Remember me
                                                </label>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12 col-lg-5 d-flex align-items-center">
                        <div class="d-flex gap-3 flex-column w-100 ">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid
                               ...
                               &redirect_uri=http://localhost:8080/showRoomOto/login

                               &response_type=code

                               &client_id=860605801896-9re9lvv2a8t0994g8vr2a3v56roos8nf.apps.googleusercontent.com
