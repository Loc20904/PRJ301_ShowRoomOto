                        ...
                        <div class="row gy-5 justify-content-center">
                            ...
                            <div class="col-12 col-lg-5 d-flex align-items-center">
                                <div class="d-flex gap-3 flex-column w-100">
                                    ...
                                    <a href="https://www.facebook.com/v20.0/dialog/oauth?client_id=1645032696144522&redirect_uri=http://localhost:8080/showRoomOto/login&state=facebook&scope=email" 
                                       class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
