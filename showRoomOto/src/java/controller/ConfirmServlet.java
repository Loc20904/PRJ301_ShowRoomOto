...
public class ConfirmServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (token == null || token.isEmpty()) {
            printError(out, "Invalid verification link!", "signup.jsp");
            return;
        }
        ...
        try (Connection conn = AccountRep.getConnect()) {
            ...
            rs.next();
            if (rs.getInt(1) == 0) {
                printError(out, "Invalid or expired verification link!", "signup.jsp");
                return;
            }
            ...
            if (rows > 0) {
                ...
                printError(out, "Failed to verify account!", "signup.jsp");
            }
        } catch (Exception e) {
            e.printStackTrace();
