...
public class DeleteCarServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        CarRep db = new CarRep();

        boolean deleted = db.deleteCar(carID);
        if (deleted) {
            response.sendRedirect("carTable.jsp");  // Quay lại danh sách sau khi xóa
        } else {
            response.getWriter().println("Failed to delete car.");
        }
    }
