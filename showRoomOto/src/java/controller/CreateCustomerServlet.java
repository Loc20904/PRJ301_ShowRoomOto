...
public class CreateCustomerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Gọi CustomerDB để thêm khách hàng
            CustomerRep customerDB = new CustomerRep();
            int newCustomerID = customerDB.newCustomer(new Customer(0, fullName, address, phoneNumber, email));
        ...
        // Chuyển hướng về trang customerTable.jsp
