 ...
 * @author phuc2
 */
public class f_booking implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if(slot==null)
        {
            request.setAttribute("erormess", "Vui lòng chọn thời gian rảnh để thử xe.");
            return;
        }
        
        if(employeeID==null)
        {
            request.setAttribute("erormess", "Vui lòng chọn nhân viên để hỗ trợ bạn.");
            return;
        }
        ...
        try {
            ...
            request.setAttribute("erormess", "Định dạng ngày không hợp lệ.");
        }
    }    
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("f_booking:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("f_booking:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("f_booking(");
