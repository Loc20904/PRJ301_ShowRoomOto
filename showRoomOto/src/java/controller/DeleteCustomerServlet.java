...
public class DeleteCustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            CustomerRep db = new CustomerRep();

            boolean deleted = db.deleteCustomer(customerID);
            if (deleted) {
                response.sendRedirect("customerTable.jsp");  // Quay lại danh sách khách hàng sau khi xóa
            } else {
