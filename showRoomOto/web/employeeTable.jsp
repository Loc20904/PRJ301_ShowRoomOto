...
<%@page import="repository.EmployeeRep"%>
<!DOCTYPE html>
<html lang="en">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#createEmployeeModal">
                                <i class="fas fa-plus fa-sm text-white-50"> </i> Create Employee
                            </a>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createEmployeeForm" action="CreateEmployeeServlet" method="post">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            <%
                                                EmployeeRep edb = new EmployeeRep();
                                                ArrayList<Employee> list = edb.listAllEmployees();
                                            ...
                                            <tr>
                                                ...
                                                <td><%= e.getPosition()%></td>
                                                <td><%= e.getStatus()%></td>
                                                <td><a href="editEmployee.jsp?employeeID=<%= e.getEmployeeId()%>">Edit</a></td>
                                                <td><a href="DeleteEmployeeServlet?employeeID=<%= e.getEmployeeId()%>" onclick="return confirm('Are you sure you want to delete this employee?');">Delete</a></td>
                                            </tr>
                                            <%
                                                }
                                            } else {
