...
<%@page import="java.util.*, model.Car, repository.CustomerRep" %>
...
<%
    ...
    CustomerRep carDB = new CustomerRep();
    Customer customer = carDB.getCustomerById(customerID);

    if (customer == null) {
%>
<script>
    alert("Car not found!");
    window.location.href = "customerTable.jsp"; // Quay lại bảng xe nếu không tìm thấy xe
</script>
<%
        return;
    }
                    ...
                    <div class="container mt-5">
                        ...
                        <form action="EditCustomerServlet" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="fullName" value="<%= customer.getFullName()%>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="phoneNumber" value="<%= customer.getPhoneNumber()%>" pattern="0[0-9]{9}" required>
                            </div>
                            ...
                            <a href="customerTable.jsp" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
