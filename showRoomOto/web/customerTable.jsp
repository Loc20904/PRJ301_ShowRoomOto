...
<%@page import="repository.CustomerRep"%>
<!DOCTYPE html>
<html lang="en">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="s_logout" data-toggle="modal" data-target="#logoutModal">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#createCustomerModal">
                                <i class="fas fa-plus fa-sm text-white-50"> </i> Create Customer
                            </a>
                        </div>
                        <!-- Modal Create Car -->
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createCustomerForm" action="CreateCustomerServlet" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" pattern="0[0-9]{9}" required>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            <%
                                                CustomerRep cdb = new CustomerRep();
                                                ArrayList<Customer> list = cdb.listAllCustomers();
                                            ...
                                            <tr>
                                                ...
                                                <td><%= c.getEmail()%></td>
                                                <td><a href="editCustomer.jsp?customerID=<%= c.getCustomerId()%>">Edit</a></td>
                                                <td><a href="DeleteCustomerServlet?customerID=<%= c.getCustomerId()%>" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</a></td>
                                            </tr>
                                            <%
                                                }
                                            } else {
