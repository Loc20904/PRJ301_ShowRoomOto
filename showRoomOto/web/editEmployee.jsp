...
<%@page import="java.util.*, model.Car, repository.EmployeeRep" %>
...
<%
    ...
    EmployeeRep carDB = new EmployeeRep();
    Employee employee = carDB.getEmployeeById(employeeID);

    if (employee == null) {
%>
<script>
    alert("Car not found!");
    window.location.href = "employeeTable.jsp"; // Quay lại bảng xe nếu không tìm thấy xe
</script>
<%
        return;
    }
                    ...
                    <div class="container mt-5">
                        ...
                        <form action="EditEmployeeServlet" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="fullName" value="<%= employee.getFullName()%>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="phoneNumber" value="<%= employee.getPhoneNumber()%>" pattern="0[0-9]{9}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="status" required>
                                    <option value="active" <%= employee.getStatus().equals("active") ? "selected" : ""%>>Active</option>
                                    <option value="inactive" <%= employee.getStatus().equals("inactive") ? "selected" : ""%>>Inactive</option>
                                </select>
                            </div>

                            <button type="submit" class="btn btn-primary">Update Employee</button>
                            <a href="employeeTable.jsp" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
