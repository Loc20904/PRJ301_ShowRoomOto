                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Car Table</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#createCarModal">
                                <i class="fas fa-plus fa-sm text-white-50"></i> Create Car
                            </a>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createCarForm" action="CreateCarServlet" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="year" name="yearOfManufacture" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="stock" name="stockQuantity" required>
                                            </div>

                                            <!-- Upload ?nh -->
                                            <div class="form-group">
                                                <label for="carImage">Car Image</label>
                                                <input type="file" class="form-control-file" id="carImage" name="carImage" accept="img/*">
                                                <small class="form-text text-muted">Upload an image for this car.</small>
                                            </div>
                                            <div class="form-group text-center">
                                                <img id="previewCarImage" src="#" alt="Image Preview" style="max-width: 150px; display: none; border-radius: 10px;">
                                            </div>
                                    ...
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>$<%= f.getPrice()%></td>
                                                <td><%= f.getYearOfManufacture()%></td>
                                                <td><%= f.getWeight()%> kg</td>
                                                <td><%= f.getStockQuantity()%></td>
                                                <td><a href="editCar.jsp?carID=<%= f.getCarID()%>">Edit</a></td>
                                                <td><a href="DeleteCarServlet?carID=<%= f.getCarID()%>" onclick="return confirm('Are you sure you want to delete this car?');">Delete</a></td>
