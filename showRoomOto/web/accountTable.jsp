                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Account Table</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#createAccountModal">
                                <i class="fas fa-plus fa-sm text-white-50"></i> Create Account
                            </a>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createAccountForm" action="CreateAccountServlet" method="post" onsubmit="return validateForm()">
                                            <!-- Username -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="role" name="role" required onchange="toggleIDFields()">
                                            ...
                                            <!-- Customer ID (Ch? hi?n th? n?u role là customer) -->
                                            <div class="form-group" id="customerIDContainer">
                                                <label for="customerID">Customer ID (Optional)</label>
                                                <input type="number" class="form-control" id="customerID" name="customerID">
                                            </div>

                                            <!-- Employee ID (Ch? hi?n th? n?u role là employee) -->
                                            <div class="form-group" id="employeeIDContainer" style="display: none;">
                                            ...
                                            <!-- Registration Date -->
                                            <div class="form-group">
                                                <label for="regisDate">Registration Date</label>
                                                <input type="date" class="form-control" name="regisDate" required>
                                            </div>
                        ...
                        <script>
                            ...
                            function toggleIDFields() {
                                ...
                                var customerIDContainer = document.getElementById("customerIDContainer");
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Account Table (Customer)</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="customerTable" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td colspan="9" class="text-center">No accounts available.</td>
                                            </tr>
                                            <%
                                                }
                                            %>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Account Table (Employees)</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
...
%>
                                            ...
                                            %>
                                            <tr>
                                                <td colspan="9" class="text-center">No employee accounts available.</td>
                                            </tr>
                                            <%
                                                }
                                            %>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="s_logout">Logout</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
                                                           $(document).ready(function () {
                                                               $('#customerTable').DataTable(); // Áp d?ng DataTable cho b?ng khách hàng
                                                               $('#employeeTable').DataTable(); // Áp d?ng DataTable cho b?ng nhân viên
                                                           });
        </script>
        <script>
