...
<%
    ...
    int carID = (carIDParam != null) ? Integer.parseInt(carIDParam) : 0;

    CarRep carDB = new CarRep();
    Car car = carDB.getCarById(carID);

    if (car == null) {
%>
<script>
    alert("Car not found!");
    window.location.href = "carTable.jsp"; // Quay lại bảng xe nếu không tìm thấy xe
</script>
<%
        return;
    }
                    ...
                    <div class="container mt-5">
                        ...
                        <form action="EditCarServlet" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="carName" value="<%= car.getCarName()%>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" required><%= car.getDescription()%></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Price</label>
                                <input type="number" step="0.01" class="form-control" name="price" value="<%= car.getPrice()%>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Year</label>
                                <input type="number" class="form-control" name="year" value="<%= car.getYearOfManufacture()%>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Weight</label>
                                <input type="number" step="0.1" class="form-control" name="weight" value="<%= car.getWeight()%>" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Stock Quantity</label>
                                <input type="number" class="form-control" name="stock" value="<%= car.getStockQuantity()%>" required>
                            </div>

                            <!-- Thêm phần upload ảnh -->
                            <div class="mb-3">
                                <label class="form-label">Car Image</label>
                                <input type="file" class="form-control" id="carImage" name="carImage" accept="img/*">
                            </div>
                            <div class="mb-3 text-center">
                                <img id="previewImage" src="<%= car.getImageURL()%>" alt="Car Image" style="max-width: 200px; display: block; border-radius: 10px;">
                            </div>

                            <button type="submit" class="btn btn-primary">Update Car</button>
                            <a href="carTable.jsp" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
