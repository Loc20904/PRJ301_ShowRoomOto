                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Booking Table</h1>
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#createBookingModal">
                                <i class="fas fa-plus fa-sm text-white-50"> </i> Create Booking
                            </a>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="createBookingForm" action="CreateBookingServlet" method="post">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">DataTables Booking</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><%= b.getEndDate()%></td>
                                                <td><%= b.getSlot()%></td>
                                                <td><a href="editBooking.jsp?bookingDetalID=<%= b.getBookingDetailID() %>">Edit</a></td>
                                                <td><a href="DeleteBookingServlet?bookingDetailID=<%= b.getBookingDetailID() %>" onclick="return confirm('Are you sure you want to delete this booking?');">Delete</a></td>
                                            </tr>
                                            <%
                                                }
                                            } else {
